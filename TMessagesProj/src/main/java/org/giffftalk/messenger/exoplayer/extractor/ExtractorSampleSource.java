 ...
 */
package org.giffftalk.messenger.exoplayer.extractor;

import org.giffftalk.messenger.exoplayer.C;
import org.giffftalk.messenger.exoplayer.MediaFormat;
import org.giffftalk.messenger.exoplayer.MediaFormatHolder;
import org.giffftalk.messenger.exoplayer.ParserException;
import org.giffftalk.messenger.exoplayer.SampleHolder;
import org.giffftalk.messenger.exoplayer.SampleSource;
import org.giffftalk.messenger.exoplayer.SampleSource.SampleSourceReader;
import org.giffftalk.messenger.exoplayer.TrackRenderer;
import org.giffftalk.messenger.exoplayer.drm.DrmInitData;
import org.giffftalk.messenger.exoplayer.upstream.Allocator;
import org.giffftalk.messenger.exoplayer.upstream.DataSource;
import org.giffftalk.messenger.exoplayer.upstream.DataSpec;
import org.giffftalk.messenger.exoplayer.upstream.Loader;
import org.giffftalk.messenger.exoplayer.upstream.Loader.Loadable;
import org.giffftalk.messenger.exoplayer.util.Assertions;
import org.giffftalk.messenger.exoplayer.util.Util;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link org.giffftalk.messenger.exoplayer.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link org.giffftalk.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link org.giffftalk.messenger.exoplayer.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link org.giffftalk.messenger.exoplayer.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link org.giffftalk.messenger.exoplayer.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link org.giffftalk.messenger.exoplayer.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link org.giffftalk.messenger.exoplayer.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link org.giffftalk.messenger.exoplayer.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link org.giffftalk.messenger.exoplayer.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link org.giffftalk.messenger.exoplayer.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.giffftalk.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
