 ...
 */
package org.giffftalk.messenger.exoplayer;

import org.giffftalk.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import org.giffftalk.messenger.exoplayer.drm.DrmInitData;
import org.giffftalk.messenger.exoplayer.drm.DrmSessionManager;
import org.giffftalk.messenger.exoplayer.util.Assertions;
import org.giffftalk.messenger.exoplayer.util.NalUnitUtil;
import org.giffftalk.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "org.giffftalk.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
